...
print("*6、欢迎下次光临            *")
print("****************************")
bank={1008611:{'password':'123456','name':123,'country':123,'province':1,'street':1,'door':1,'bank_name':'中国工商银行','money':1000}  }
bank_name='中国工商银行'
def useradd():
    ...
    door=input('请输入您的门牌号')
    gift=bank_add(card_id,password,name,country,province,street,door)
...
def bank_add(card_id,password,name,country,province,street,door):
    if card_id in bank:
        return 2
    elif len(bank)>=100:
        return 3
...
def check():
    ...
    if gift6==0:
        ...
        info = '''
               ...
               '''
        print(info % (card_id, password, bank[card_id]['name'], bank[card_id]['country'], bank[card_id]['province'], bank[card_id]['street'], bank[card_id]['door'], bank[card_id]['money']))
